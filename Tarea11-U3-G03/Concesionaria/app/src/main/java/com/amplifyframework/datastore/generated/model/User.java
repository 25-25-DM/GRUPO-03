...
public final class User implements Model {
  ...
  private User(String id, String fullName, String password) {
    this.id = id;
  ...
  public static class Builder implements BuildStep {
    ...
    private Builder(String id, String fullName, String password) {
      this.id = id;
      this.fullName = fullName;
      this.password = password;
    }
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String fullName, String password) {
